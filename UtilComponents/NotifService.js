...
export default class NotifService {
  ...
  createDefaultChannels() {
    ...
    PushNotification.createChannel(
      {
        channelId: "sound-channel-id1", // (required)
        channelName: `Sound channel`, // (required)
        channelDescription: "A sound channel", // (optional) default: undefined.
        importance: 4, // (optional) default: 4. Int value of the Android notification importance
        sound:'android.resource://com.betterlearning/raw/alert_asterisk_9',
  ...
  scheduleNotif(time) {
    ...
    PushNotification.localNotificationSchedule({
      ...
      message:'This is a test', //'Your study time is complete', // (required)
      soundName: 'android.resource://com.betterlearning/raw/alert_asterisk_9',
      //sound: 'default',
